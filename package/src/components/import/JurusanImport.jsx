...
export default function JurusanImport({ isImport, onClose, setRefresh }) {
  ...
  const handleImport = async () => {
    if (selectedFile) {
      ...
      try {
        await Api.post("/jurusan/import", formData, {
          headers: {
        ...
        setRefresh(true);
        Toast({ message: "Data jurusan berhasil diimport", type: "success" });
      } catch (error) {
        Toast({ message: "Data jurusan gagal diimport", type: "error" });
      }
    }
  };
